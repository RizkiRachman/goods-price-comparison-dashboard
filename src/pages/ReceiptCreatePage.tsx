    ...
    <div className="min-h-screen bg-retro-bg">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 -mt-4 pb-12 space-y-4">
            ...
            {items.map((item, i) => {
              ...
              return (
                <div key={i} className={`px-5 py-4 ${hasIssue ? 'bg-retro-danger/10' : ''}`}>
                  ...
                  <div className="mb-3">
                    <label className="text-xs font-medium text-retro-muted">Kategori</label>
                  ...
                  <div className="grid grid-cols-3 gap-3 items-start">
                    <div className="flex flex-col gap-1.5">
                      <label className={`text-xs font-medium flex items-center gap-1 ${badQty ? 'text-retro-danger' : 'text-retro-muted'}`}>
                        Jumlah
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className={`text-xs font-medium flex items-center gap-1 ${badPrice ? 'text-retro-danger' : 'text-retro-muted'}`}>
                        Harga Satuan
                  ...
                  <p className="text-right text-sm font-bold text-retro-text mt-2">
                    {fmt(item.totalPrice)}
                  </p>
                </div>
              )
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3.5 rounded-none font-bold text-sm text-white bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed transition"
        >
          {create.isPending ? (
            <>⏳ Menyimpan…</>
          ) : saved ? (
