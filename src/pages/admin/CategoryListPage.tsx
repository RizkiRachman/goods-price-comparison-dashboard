  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-slate-800">Kategori</h1>
          <p className="text-sm text-slate-400 mt-0.5">Kelola kategori produk</p>
        </div>
        <button
      ...
      {isLoading ? (
        ...
        <DataTable
          ...
          onRowClick={(c) => navigate(`/admin/categories/${c.id}/edit`)}
          actions={(c) => (
            <div className="flex items-center gap-2">
              <button
                onClick={(e) => { e.stopPropagation(); navigate(`/admin/categories/${c.id}/edit`) }}
