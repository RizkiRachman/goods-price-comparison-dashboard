    ...
    <div className="bg-retro-surface/80 backdrop-blur-xl border border-retro-border/20 rounded-none overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <button
          ...
          className="w-7 h-7 flex items-center justify-center rounded-none text-gray-300 hover:text-retro-muted hover:bg-retro-surface-alt transition flex-shrink-0"
        >
      ...
      {(isPendingReview || isLlmReady) && (
        <div className="border-t border-retro-border/20 px-4 py-3 space-y-3">
          ...
          {validationIssues.length > 0 && (
            <div className="bg-amber-50/80 backdrop-blur-sm border border-amber-200 rounded-none px-3 py-2.5 space-y-1">
          ...
          <button
            ...
            className={`w-full py-2 text-xs font-semibold rounded-none transition ${
              !canApprove
                ? 'text-retro-text bg-retro-warning hover:bg-amber-600 animate-pulse'
                : 'text-retro-warning bg-amber-50/80 backdrop-blur-sm hover:bg-amber-100'
            }`}
          >
