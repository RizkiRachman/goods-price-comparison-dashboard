        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-white/20">
              ...
              <button
                onClick={onClose}
                className="w-9 h-9 flex items-center justify-center bg-white/50 hover:bg-white/70 rounded-xl transition-colors"
                aria-label="Tutup"
              >
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
              {/* Hero card */}
              <div className="bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-700 rounded-2xl p-6 relative overflow-hidden">
                <div className="absolute -top-10 -right-10 w-40 h-40 bg-white/10 rounded-full blur-2xl" />
                <div className="absolute bottom-0 left-0 w-32 h-24 bg-amber-400/10 rounded-full blur-xl" />
                <div className="relative">
                  <p className="text-white/50 text-xs font-semibold uppercase tracking-widest mb-2">Versi 0.2.0</p>
                  <h2 className="text-2xl font-black text-white tracking-tight mb-4">HargaKu</h2>
              ...
              {/* Features */}
              <section>
                <h3 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-3">Fitur</h3>
                <div className="space-y-2">
                  {[
                    ...
                    <div key={f.title} className="flex items-start gap-3 px-3.5 py-3 bg-white/40 backdrop-blur-sm border border-white/20 rounded-xl">
              ...
              <section>
                <div className="flex items-center gap-2 mb-3">
                  <h3 className="text-xs font-bold text-slate-500 uppercase tracking-widest">Admin</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  {[
                    ...
                    <button
                      ...
                      className="flex items-start gap-3 px-3.5 py-3 bg-white/40 backdrop-blur-sm border border-white/20 rounded-xl hover:bg-white/60 transition-colors text-left"
                    >
                      <span className="text-base mt-0.5">{f.icon}</span>
                      <div className="min-w-0">
                        <p className="text-sm font-semibold text-slate-800">{f.title}</p>
              ...
              {/* Source Code */}
              <section>
                <h3 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-3">Source Code</h3>
                <div className="space-y-2">
                  {REPOS.map((repo) => (
                    <a
                      key={repo.url}
                      ...
                      className="flex items-center gap-3 px-4 py-3 bg-white/50 backdrop-blur-sm hover:bg-white/70 border border-white/30 rounded-xl transition-colors group"
                    >
                      <svg className="w-4.5 h-4.5 text-slate-600 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-slate-800 group-hover:text-indigo-600 transition-colors truncate">{repo.name}</p>
              ...
              <section>
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3.5 bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-xl shadow shadow-indigo-300/40 hover:shadow-md hover:shadow-indigo-400/40 transition-all active:scale-[0.98]"
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs text-white/70">Bantu kami meningkatkan HargaKu</p>
                  </div>
                </button>
              </section>
            </div>
