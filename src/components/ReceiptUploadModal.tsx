      ...
      <div className="relative bg-white w-full sm:max-w-md rounded-t-3xl sm:rounded-3xl shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="px-6 pb-6 sm:pb-8 flex flex-col gap-4">
          ...
          >
            ...
            {file ? (
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-xs text-gray-400">{(file.size / 1024).toFixed(1)} KB · Siap diupload</p>
              </div>
            ) : (
              <div className="flex flex-col items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">Foto struk supermarket · JPG, PNG, PDF · Maks 10 MB</p>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="flex items-center gap-2 text-xs text-gray-400">
            ...
            Upload foto struk belanja. Data akan diproses dan dicatat secara otomatis.
          </div>
